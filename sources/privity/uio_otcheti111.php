...
function Form(){
	$pagetext = "<form  name = 'form1' method=POST action='uio_editSotrudniki.php'  >
		 ...
		 <tr>
			...
			<td width=5%>Техническое&nbsp;состояние&nbsp;помещения</td>
  ...
  FROM
	...
	WHERE ((Ispolzovnie_pomesheniya.Data_okonchaniya_ispolzovaniya='0000-00-00' ) AND (Tehnicheskoe_sostoyanie_pomeseniya.Okna!='отличное')  AND (Tehnicheskoe_sostoyanie_pomeseniya.Okna!='хорошее') AND (Tehnicheskoe_sostoyanie_pomeseniya.Dveri!='отличное') AND (Tehnicheskoe_sostoyanie_pomeseniya.Dveri!='хорошее') AND (Tehnicheskoe_sostoyanie_pomeseniya.Steni!='отличное') AND (Tehnicheskoe_sostoyanie_pomeseniya.Steni!='хорошее') AND (Tehnicheskoe_sostoyanie_pomeseniya.Pol!='отличное') AND (Tehnicheskoe_sostoyanie_pomeseniya.Pol!='хорошее') AND (Tehnicheskoe_sostoyanie_pomeseniya.Potolok!='отличное') AND (Tehnicheskoe_sostoyanie_pomeseniya.Potolok!='хорошее')) order by Pomesenie.Nomer_korpusa_FK",$db);
